...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/petservices?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        globalConfig.setAuthor("");    //设置作者
        ...
        packageInfo.setParent("com.petservices");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        ...
        strategyConfig.setInclude("serve");  //设置当前参与生成的表名，参数为可变参数
